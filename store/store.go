...
func (s *DefaultStore) SaveBlockResponses(height uint64, responses *cmstate.LegacyABCIResponses) error {
...
func (s *DefaultStore) LoadBlockResponses(height uint64) (*cmstate.LegacyABCIResponses, error) {
	...
	var responses cmstate.LegacyABCIResponses
