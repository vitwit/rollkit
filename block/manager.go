...
func (m *Manager) ProcessFraudProof(ctx context.Context, cancel context.CancelFunc) {
	...
	for {
		...
		success, err := m.executor.VerifyFraudProof(ctx, &fraudProof.FraudProof, fraudProof.ExpectedValidAppHash)
		if err != nil {
...
func (m *Manager) publishBlock(ctx context.Context) error {
	...
	if err == nil {
		...
		block = m.executor.CreateBlock(ctx, newHeight, lastCommit, lastHeaderHash, m.lastState)
